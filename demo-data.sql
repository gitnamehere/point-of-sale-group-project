...
UPDATE business_information SET business_name = 'ATS', email = 'ATS@email.com', address_one = '1 Trinkets Way', address_two = 'San Antonio, TX 78015', phone_number = '123-456-7890', description = 'ATS or APES TOGETHER STRONG is a group dedicated to its craft. Nobody can stand in their way as they will always be together thus strong. Those have nothing to fear but ATS. We sell many things that appeal to a variety. If it does not appeal you, then we will come after you until it does.', tax_rate = 0.08
